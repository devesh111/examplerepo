...
export function EnhancedVideoPlayer({ videoUrl, onClose }: EnhancedVideoPlayerProps) {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full bg-black flex flex-col">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black via-black/50 to-transparent p-4 flex items-center justify-between z-40">
        {/* Speed Controls */}
        <div className="flex gap-2">
          <span className="text-white text-sm font-semibold mr-2">Speed:</span>
        ...
        <div className="flex items-center gap-2">
          <label className="text-white text-sm font-semibold">Quality:</label>
          <select
